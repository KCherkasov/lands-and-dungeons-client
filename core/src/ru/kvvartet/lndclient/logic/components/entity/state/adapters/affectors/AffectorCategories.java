...
public final class AffectorCategories {
    ...
    public static final int AC_MULTI_VALUE_AFFECTORS = AC_STATS_AFFECTOR | AC_RATINGS_AFFECTOR
            | AC_DAMAGE_AFFECTOR | AC_DEFENSE_AFFECTOR | AC_OVER_TIME_AFFECTOR
            | AC_WEAPON_DAMAGE_AFFECTOR | AC_ABILITY_HEALTH_AFFECTOR;
